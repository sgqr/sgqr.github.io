	...
	class generateSGQR{
	  ...
	  generate( opts ) {
		...
		let otherdata = [
	      ...
	      { id: '59', value: String(opts.merchant || '') },          // ID 59: Company Name
	      { id: '60', value: 'Singapore' }             // ID 60: Merchant City 
	    ];

		p = p.concat(otherdata);
		console.log(p)
		...
		console.log(this.crc16(str + '6304'))
